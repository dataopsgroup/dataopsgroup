...
export const peCrmChaosToControl: BlogPost = {
  ...
  content: `
    ...
    <p>But here's the thing: the problem isn't always the <em>idea</em> of a CRM. It's the <em>approach</em> to implementing it in a PE context. Especially in the mid-market, trying to replicate a mega-fund's tech stack is often overkill and counterproductive. You need a CRM that fits. A system that's scalable and cost-effective, yes, but also user-friendly enough that your portco teams will <em>actually use it</em>. You need visibility, sure, but you also need a tool that helps your acquired companies grow faster, cleaner, and more predictably.</p>
    ...
    <p>Think of this like decluttering before you renovate. You're not building the whole house yet, you're just making the space usable. The goal is to get <em>usable</em> data into a standardized structure and implement basic rules to keep it clean.</p>
