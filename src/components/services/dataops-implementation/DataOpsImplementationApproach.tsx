      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2 font-rubik">Portfolio Assessment & Strategy</h3>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2 font-rubik">System Architecture Design</h3>
              <p className="text-gray-700 font-roboto leading-relaxed">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2 font-rubik">Phased Implementation & Integration</h3>
              <p className="text-gray-700 font-roboto leading-relaxed">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2 font-rubik">Training & Change Management</h3>
              <p className="text-gray-700 font-roboto leading-relaxed">
