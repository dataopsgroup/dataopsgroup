    ...
    <section className="pt-32 pb-16 px-4 bg-gradient-to-br from-white to-gray-50">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          <div 
            className="lg:col-span-2 space-y-6 relative p-8 rounded-xl border border-gray-100 bg-white"
          ...
          >
            {/* Subtle overlay for text readability when background image is present */}
            {backgroundImage && (
              <div className="absolute inset-0 bg-white/85 rounded-xl"></div>
            )}
            
            {/* Content with higher z-index when background is present */}
