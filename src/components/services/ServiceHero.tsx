        ...
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-3 flex justify-end">
            {isHubSpotTraining ? (
              ...
              <div className="relative bg-white rounded-2xl shadow-xl p-12 z-10 w-full max-w-xl">
                <div className="flex justify-center items-center h-72 w-full rounded-lg bg-dataops-50">
