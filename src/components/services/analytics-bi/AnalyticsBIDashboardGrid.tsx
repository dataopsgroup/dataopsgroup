...
const benefits = [
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=800&q=80', imageAlt: "Dashboard screen showing marketing ROI analytics", title: "Measure Marketing ROI", description: "Gain investor-grade accuracy in measuring marketing performance and ROI." },
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1542626991-a2f572a1e84d?w=800&q=80', imageAlt: "Diagram on a whiteboard representing process optimization and efficiency", title: "Optimize Efficiency", description: "Enhance operational efficiency and performance across the portfolio." },
