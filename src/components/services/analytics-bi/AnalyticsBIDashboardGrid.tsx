...
const benefits = [
  { imageUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80', imageAlt: "Close-up of a circuit board representing interconnected and standardized data systems", title: "Standardize Reporting", description: "Achieve consistent, reliable reporting across all portfolio companies." },
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=800&q=80', imageAlt: "A team collaborating over documents and diagrams to optimize operational efficiency", title: "Optimize Efficiency", description: "Enhance operational efficiency and performance across the portfolio." },
