...
const benefits = [
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&q=80', imageAlt: "Team collaborating around a table with diagrams to optimize efficiency", title: "Optimize Efficiency", description: "Enhance operational efficiency and performance across the portfolio." },
