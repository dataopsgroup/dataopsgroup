...
const benefits = [
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?w=800&q=80', imageAlt: "Overhead view of a team collaborating with documents and diagrams on a table", title: "Optimize Efficiency", description: "Enhance operational efficiency and performance across the portfolio." },
