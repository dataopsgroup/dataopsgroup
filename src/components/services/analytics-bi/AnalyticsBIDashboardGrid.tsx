...
const benefits = [
  ...
  { imageUrl: 'https://images.unsplash.com/photo-1620706857370-e1b9770e8bbe?w=800&q=80', imageAlt: "Robotic arm on an assembly line, representing optimized efficiency", title: "Optimize Efficiency", description: "Enhance operational efficiency and performance across the portfolio." },
