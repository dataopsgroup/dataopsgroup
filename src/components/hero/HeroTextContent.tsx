      ...
      <div className="hero-text-overlay">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div>
              <Link to="/contact" onClick={onCTAClick} className="inline-flex items-center bg-white text-purple-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors md:bg-blue-600 md:text-white md:hover:bg-blue-700 font-body">
                Book My Assessment
