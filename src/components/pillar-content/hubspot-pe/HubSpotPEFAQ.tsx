          ...
          {faqs.map((faq, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              ...
              >
                ...
                {openFAQ === index ? (
                  <Minus className="h-5 w-5 text-dataops-600 flex-shrink-0" />
                ) : (
                  <Plus className="h-5 w-5 text-dataops-600 flex-shrink-0" />
                )}
              </button>
        ...
        <div className="mt-12 text-center">
          <div className="bg-dataops-50 border border-dataops-100 rounded-lg p-8">
            ...
            <p className="text-gray-700 mb-6">
              Schedule a consultation with our PE operations specialists to discuss your specific requirements 
              and get personalized answers about your HubSpot implementation.
            </p>
            <a 
              href="/contact"
