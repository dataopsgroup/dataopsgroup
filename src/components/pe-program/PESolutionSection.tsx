  ...
  const differentiators = [
    {
      ...
      details: [
        "Built-in board reporting and investor communication frameworks",
        "Designed around your 3-7 year value creation timeline"
      ]
    },
    {
      icon: Cog,
      ...
      details: [
        "Industry-specific templates that reduce implementation risk",
        "Systematic quality controls ensure consistent outcomes"
      ]
    },
    {
      icon: Rocket,
      ...
      details: [
        "Immediate operational improvements while building long-term capability",
        "Your team becomes 90% self-sufficient, with us as strategic partners"
      ]
    }
  ];
