        ...
        <div className="container mx-auto px-[5%]">
          ...
          <div className="prose max-w-4xl mx-auto mb-16">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GeoffTucker.com LLC, 84 E Loveland Loop - B, Farmington, AR 72730.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to Geoff Tucker, accessible from <a href="https://www.geofftucker.com" rel="external nofollow noopener" target="_blank">https://www.geofftucker.com</a></p>
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>By visiting this page on our website: <a href="https://www.geofftucker.com/privacy-policy" rel="external nofollow noopener" target="_blank">https://www.geofftucker.com/privacy-policy</a></li>
            </ul>
          </div>
        </div>
      </main>
