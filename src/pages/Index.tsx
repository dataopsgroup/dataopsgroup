...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <MetaHead 
        title="HubSpot Not Delivering ROI? We Fix That | DataOps Group"
        description="Stop losing money on underperforming HubSpot. We rescue broken implementations, optimize workflows, and turn your CRM into a revenue machine. Free audit."
