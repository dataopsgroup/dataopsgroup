...
const PEValueCreationPage = () => {
  return <SemanticLayout>
      <MetaHead title="100-Day PE Portfolio Company Transformation | DataOps Group" description="Systematic 100-day program transforms PE portfolio companies into unified value creation engines. Drive EBITDA growth through operational excellence." keywords="private equity, portfolio company transformation, hubspot implementation, operational efficiency, value creation, PE consulting" canonicalPath="/pe-value-creation-program" ogType="website" ogTitle="100-Day PE Portfolio Company Transformation | DataOps Group" ogDescription="Systematic 100-day program transforms PE portfolio companies into unified value creation engines. Drive EBITDA growth through operational excellence." ogImage="/lovable-uploads/9b9f1c84-13af-4551-96d5-b7a930f008cf.png" siteName="DataOps Group" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm max-w-2xl mx-auto">
                ...
                <a href="/revops-roi-calculator" className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg font-semibold text-lg transition-colors inline-block">
                  Calculate Your Program ROI
                </a>
                <p className="text-sm text-gray-500 mt-4">Takes 3 minutes • Shows 12-month projection</p>
              </div>
            </div>
          </div>
        </section>
